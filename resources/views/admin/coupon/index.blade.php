                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Bảng Mã Giảm Giá</strong>
                                <br>
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{URL::to('/admin/coupon/create') }}">
                                    <button class="btn btn-outline-primary" style="margin-bottom: 15px;"><i class="fa fa-star"></i>Thêm Mã Giảm Giá</button>
                                </a>
                                @endif
                                @endforeach
                                    ...
                                    <tbody>
                                       ...
                                       <td>{{$item->coupon_name}}</td>
                                        ...
                                        {{-- @if($v->role_module=="role_edit_size")
                                            ...
                                            @endif --}}
                                            @if($v->role_module=="role_delete_coupon")
                                            <td>
                                                
                                                <form action="coupon/delete/{{$item->id_coupon}}" method="post">
                                                    @csrf
