...
route::prefix('admin')->group( function()
{
    ...
    route::prefix('size')->group( function(){
        ...
        route::get('/create',  [CategoryController::class, 'create']);
        route::post('/create',  [CategoryController::class, 'store']);
        Route::get('/edit/{idsize}',[CategoryController::class,'edit']);
        Route::put('/edit/{idsize}',[CategoryController::class,'update']);
        Route::delete('/delete/{idsize}',[CategoryController::class,'destroy']);
    });
