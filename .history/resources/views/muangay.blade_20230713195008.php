                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <p hidden name="id_product" >{{ $detaila['name_product']}}</p>
                            <p name="name_product">{{ $detaila['name_product']}}</p>
                            <p name="quantity"> 1</p>
                            <p name="size">{{ $detaila['name_product']}}</p>
                            <p name="color">{{ $detaila['name_product']}}</p>
