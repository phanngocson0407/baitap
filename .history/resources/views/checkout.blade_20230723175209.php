     ...
     @endif
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <input type="hidden" name="total" value="{{Session::get('Cart')->totalPrice+ 30000-$total_coupon}}">
                            <h5 class="font-weight-bold">{{(number_format(Session::get('Cart')->totalPrice+ 30000-$total_coupon, 0, '.', '.') . ' VNĐ') }}</h5>
                        </div>
                        @endforeach
                        @else
        ...
        <div class="col-lg-5">
            ...
            <form action="{{url('/momopayment')}}" method="post" style=" padding: 0px 19px;">
                ...
                <button style="border-radius: 10px; max-width: 300px; "  type="submit" name="payUrl"  class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3" >Thanh ToГЎn MoMo </button>           
            </form>
        </div>
        </div>
