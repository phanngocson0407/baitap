...
<div class="container-fluid py-5">
    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 pb-5">
            ...
            <div class="d-flex mb-3">
                <div class="text-primary mr-2" style="with:20%;position:relative">
                    <span class="fa fa-star"
                        style="font-size: 50px;color:rgb(209,156,151); margin:0 auto; text:align: center;"></span>
            ...
            <a onclick="AddCart({{ $detail['id'] }})" href="javascript:" class="btn btn-primary px-3"><i
            ...
            @else
            <a onclick="AddCart({{ $detail['id'] }})" href="{{URL('/checkout')}}" class="btn btn-primary px-3"><i
                    class="fa fa-shopping-cart mr-1"></i> Mua Ngay</a>
            @endif
