...
<div class="container-fluid py-5">
  ...
  #scrollableDiv::-webkit-scrollbar-track {
    ...
    <div class="container">
        <h4 style="color: "><b>Đánh giá & Nhận xét về  sản phẩm {{ $detail['name_product'] }} </b></h4>
        <div class="row">
            <div class="col-md-6">
                <div>
                  <h4 style="color: "><b>Đánh giá & Nhận xét sản phẩm {{ $detail['name_product'] }} </b></h4>
              
                  <div class="style_comment" id="scrollableDiv" style="max-height: 500px; overflow: auto; background-color: white; padding: 20px">
                    <?php $n=0 ?>
