                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            <button data="{{$item['productInfo']->id}}"
                                class="btn btn-sm btn-primary btn_update_list edit_all"
                        ...
                        <td class="align-middle">
                            <div class="input-group quantityy mx-auto" style="width: 100px;">
                                <div class="input-group quantityy mr-3" style="width: 130px;">
                                    ...
                                    <input type="text" class="form-control bg-secondary text-center quantityInput" data-id="{{$item['productInfo']->id}}"
                                        id="quantityInput_{{$item['productInfo']->id_size}}.{{$item['productInfo']->id_color}}"
                                        value="{{$item['quanty']}}">
                                    <div class="input-group-btn">
