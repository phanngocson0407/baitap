    ...
    <form action="/" method="get" style="width: 500px;">
        ...
        <div class="input-group">
            ...
            <select class="form-control select-filter" name="sort_by" id="sort" style="width: 170px;">
                ...
                <option value="kytu_za"{{ Request::input('sort_by') === 'sort_by?kytu_za' ? ' selected' : '' }}>Từ Z-A</option>
                <option value="tang_dan"{{ Request::input('sort_by') === 'sort_by?tang_dan' ? ' selected' : '' }}>Giá tăng dần</option>
                <option value="giam_dan"{{ Request::input('sort_by') === 'sort_by?giam_dan' ? ' selected' : '' }}>Giá giảm dần</option>
            </select>
