            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex mb-3">
                    <div class="text-primary mr-2" style="with:20%;position:relative">
                        <span class="fa fa-star" style="font-size: 30px;color:rgb(209,156,151); margin:0 auto; text:align: center;"></span>
                ...
                <div class="d-flex mb-3">
                    <p  style="font-weight: 700;font-size: 27px" class="text-dark font-weight-medium mb-0 mr-3">Giá:</p>
                    <p style="font-weight: 700;font-size: 27px" class="font-weight-semi-bold mb-4">{{number_format($detail->price).''.'₫' }}</p>
                </div>
            
                <div class="d-flex mb-3">
                    <p style="font-weight: 700;font-size: 27px;white-space: nowrap; "  class="text-dark font-weight-medium mb-0 mr-3">Mô tả:</p>
