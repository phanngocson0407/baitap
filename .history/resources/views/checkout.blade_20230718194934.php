            ...
            <div class="col-lg-5">
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent" style="display:flex; ">
                       <input type="submit" style="border-radius: 10px; max-width: 2" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3" value="Thanh Toán bằng tiền mặt"> 
