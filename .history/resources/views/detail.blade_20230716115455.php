                  ...
                  <div class="style_comment" id="scrollableDiv" style="max-height: 220px; overflow: auto; background-color: white">
                    ...
                    @foreach($comment as $item)
                      @if($item->status==1)
                        <?php $n++ ?>
                        <div>
                          <p style="font-size: 23px; font-weight: 700; line-height: 22.4px;color: #c5837c" class="text-dark font-weight-medium mb-0 mr-3"> <span>Khách Hàng:</span> {{$item->comment_name}}</p>
