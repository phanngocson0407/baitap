...
function decreaseQuantity(inputId) {
    ...
    var button = $(this);
    var inputId = button.attr('data');
    var quantityInput = $('#quantityInput_' + inputId).val();

    $.ajax({
        type: "GET",
        data: {
            id: inputId, // Thay đổi tên tham số từ id_color_size thành id
            quantity: quantityInput // Thêm thông tin số lượng vào dữ liệu gửi đi
        },
