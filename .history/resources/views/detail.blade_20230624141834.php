            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex mb-3">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                            ...
                            <input   type="radio" class="custom-control-input" id="{{$product['id_size'] }}" name="{{{{$product['id_product'] }}}}">
                     
                        <label class="custom-control-label" for="{{$product['id_size'] }}">{{$product['number_size'] }}</label>
