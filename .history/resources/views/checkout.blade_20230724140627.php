            ...
            <div class="col-lg-5">
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <input hidden type="text" required name="status_payment" value="0" id="">
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <p class="font-weight-bold">
                                ...
                                <input hidden type="text" required name="status_payment" value="1" id="">

                                @else
                                {{$cou['coupon_code']}}
                                <input hidden type="text" required name="status_payment" value="2" id="">
                                @endif
...
<div class="row px-xl-4">
    ...
    <div class="col-lg-5">
        ...
        <form action="{{url('/vnpayment')}}" method="post" style=" padding: 0px 19px;">
            ...
            <input type="text" name="total" value="{{(Session::get('Cart')->totalPrice+ 30000 -$total_coupon) }}">
            @endforeach
            @else
            <input type="text" name="total" value="{{(Session::get('Cart')->totalPrice+ 30000) }}">
            @endif
