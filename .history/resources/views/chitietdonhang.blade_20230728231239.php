        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    <label>Họ tên</label>
                    <input class="form-control"   name="consingnee_name" type="text"
                        value="{{$item->consingnee_name}}">
                </div>
                <div class="col-md-12 form-group">
                    <label>Email</label>
                    <input class="form-control"   name="consingnee_email" type="email"
                        value="{{$item->consingnee_email}}">
                </div>
                <div class="col-md-12 form-group">
                    <label>Phone</label>
                    <input class="form-control"   name="consingnee_phone" type="number"
