                ...
                <div>
                    <form action="/" method="get" style="width: 500px;">
                        <div class="input-group">
                            <input type="text" class="form-control" value="{{ old('data') }}" name="kw" placeholder="Tìm kiếm sản phẩm">
                            <input type="text" class="form-control" value="{{ old('price') }}" name="price" placeholder="Tìm kiếm theo giá">
