                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><button class="btn btn-sm btn-primary"><i id="save-cart-item-{{$item['productInfo']->id}}" onclick="DeleteListItemCart({{$item['productInfo']->id}});" class="fa fa-times"></i></button></td>
                            <td class="align-middle"><button class="btn btn-sm btn-primary"><i onclick="updateQuantity({{$item['productInfo']->id}});" class="">Cập nhật</i></button></td>
                        </tr>
                    @endforeach
                         @endif
                    </tbody>
