    ...
    <div class="container-fluid pt-5">
        ...
        <div class="col-lg-5">
            <form action="{{url('/vnpayment')}}" method="post">
                ...
                <button style="border-radius: 10px; max-width: 300px; padding: ;"  type="submit" name="redirect"  class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3" >Thanh Toán VNPAY </button>           
            </form>
        </div>
        </div>
