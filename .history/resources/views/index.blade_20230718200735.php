...
<div class="container-fluid pt-5">
    ...
    <div class="row">
        <div class="col-md-3" style=" display: flex;justify-content: space-between;">
            ...
            <div  >
                <form action="/" method="get" style="width: 500px;" class="row px-xl-4">
                <div class="col-lg-3">  <select class="form-control select-filter" name="sort" id="sort" style="width: 170px;">
                ...
                <div class="col-lg-3">       <input type="text" class="form-control" name="kw" placeholder="Ten sản phẩm"
                    value="<?php echo isset($_GET['kw']) ? $_GET['kw'] : ''; ?>"></div>
                <div class="col-lg-3">      <input type="text" class="form-control" name="price" placeholder="Tìm kiếm theo giá"
                    value="<?php echo isset($_GET['price']) ? $_GET['price'] : ''; ?>"></div>
                <div class="col-lg-3">     <input type="text" class="form-control" name="price2" placeholder="Tìm kiếm theo giá"
                    value="<?php echo isset($_GET['price2']) ? $_GET['price2'] : ''; ?>"></div>
