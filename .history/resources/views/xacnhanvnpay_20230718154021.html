                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" name="consingnee_address" type="text"  value="{{$_GET['vnp_TxnRef']}}" readonly>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Mã giao dịch</label>
                            <input class="form-control" name="consingnee_address" type="text"  value="{{$_GET['vnp_TransactionNo']}}" readonly>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Ngày tạo</label>
                            <?php
                                $vnpPayDate = $_GET['vnp_PayDate'];
                                $formattedDate = date('d/m/Y H:i:s', strtotime($vnpPayDate));
                            ?>
                            <input class="form-control" name="consignee_address" type="text" value="<?php echo $formattedDate; ?>" readonly>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Ngân hàng</label>
                            <input class="form-control" name="consingnee_address" type="text"  value="{{$_GET['vnp_BankCode']}}" readonly>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Nội dung thanh toán</label>
                            <input class="form-control" name="consingnee_address" type="text"  value="{{$_GET['vnp_OrderInfo']}}" readonly>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent" style="display:flex;">
                       <input type="submit" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3" value="Xác nhận thanh toán"> 
