                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <p>{{(number_format(Session::get('Cart')->totalPrice+ 30000-$total_coupon, 0, '.', '.') . '
                                VNĐ') }}</p>
                        </div>
                        @endforeach
                        @endif
...
<div class="row px-xl-4">
    ...
    <div class="col-lg-5">
        ...
        <form action="{{url('/vnpayment')}}" method="post" style=" padding: 0px 19px;">
            ...
            <input type="hidden" name="totalvnpay" value="{{(Session::get('Cart')->totalPrice+ 30000-$total_coupon) }}">
            @else
            $total_coupon = ( $cou['coupon_number']);
            <input type="hidden" name="totalvnpay" value="{{(Session::get('Cart')->totalPrice+ 30000-$total_coupon) }}">
            @endif
