...
<div class="container-fluid py-5">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div>
                  <h4 style="color: "><b>Đánh giá & Nhận xét sản phẩm {{ $detail['name_product'] }} </b></h4>
              
                  <div class="style_comment" id="scrollableDiv" style="max-height: 220px; overflow: auto; background-color: white; padding: 20px">
                    <?php $n=0 ?>
                    @foreach($comment as $item)
                      @if($item->status==1)
                        ...
                        <div>
                          ...
                          <p><span class="text-dark" style="font-size: 15px; font-weight: 700; line-height: 22.4px;">Ngày:</span> <?php echo date('d/m/Y', strtotime($item->comment_date)); ?></p>
                        </div>
                        <div>
                            <p><span class="text-dark" style="font-size: 15px; font-weight: 700; line-height: 22.4px;">Bình luận:</span> <?php echo date('d/m/Y', strtotime($item->comment_date)); ?></p>
