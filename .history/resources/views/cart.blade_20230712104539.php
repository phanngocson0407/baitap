                            ...
                            <td class="align-middle">
                                <div class="input-group quantityy mx-auto" style="width: 100px;">
                                    <div class="input-group quantityy mr-3" style="width: 130px;">
                                        ...
                                        <input type="text" class="form-control bg-secondary text-center quantityInput{{$item['productInfo']->id.$item['productInfo']->id_size.$item['productInfo']->id_color}}" 
                            ...
                            <td class="align-middle">
                                <button
                                 data="{{$item['productInfo']->id}}"
                                   class="btn btn-sm btn-primary btn_delete_list"
...
function decreaseQuantity(itemId) {
    ...
    var quantity = $('#quantityInput_' + id_color_size).val();
    ...
    $.ajax({
        ...
        url: "/Save-List-Item-Cart/" + $(this).attr('data') + '/' + $(this).quantity,
    }).done(function(response) {
        RenderListCart(response);
        alertify.success('Cập nhật giỏ hàng thành công');
