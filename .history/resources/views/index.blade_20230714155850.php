                ...
                <div>
                    <form action="/" method="get" style="width: 500px;">
                        <div class="input-group">
                            <input type="text" class="form-control" name="kw" id="searchInput" placeholder="Tìm kiếm sản phẩm">
                            <input type="text" class="form-control" name="price" id="priceInput" placeholder="Tìm kiếm theo giá">
                
                            <div class="input-group-append">
                                <input type="submit" class="input-group-text bg-transparent text-primary" value="Tìm Kiếm" onclick="saveSearchValues()">
                            </div>
                        </div>
                    </form>
                </div>
  ...
  if (selectedSort) {
    ...
    <script>
        function saveSearchValues() {
            ...
            localStorage.setItem("searchPrice", priceInput.value);
        }
    
        // Để lấy giá trị tìm kiếm đã lưu:
        var savedKeyword = localStorage.getItem("searchKeyword");
        var savedPrice = localStorage.getItem("searchPrice");
    
        // Sử dụng giá trị tìm kiếm đã lưu để thực hiện các hành động khác trên trang web của bạn.
    </script>
        <script>
            $(document).ready(function(){
