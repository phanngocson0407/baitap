...
@section('user')
    ...
    <div class="justify-content-center">
        ...
        <div class="row">
            ...
            <button  style="border-radius: 10px; max-width: 300px; "  class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3 d-flex justify-item-center " type="submit"> cập nhật</button>
             </form>
