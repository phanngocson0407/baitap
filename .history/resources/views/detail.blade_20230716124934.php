            ...
            <div class="col-md-6">
                <div>
                    ...
                    <div class="style_comment" id="scrollableDiv" style="max-height: 550px; overflow: auto; background-color: white; padding: 20px">
                      ...
                      Trong mã trên, biến $count được sử dụng để đếm số lượng bình luận được hiển thị. Sau vòng lặp foreach, chúng ta kiểm tra nếu $count bằng 0, thì câu thông báo "Không có bình luận" sẽ được hiển thị.
