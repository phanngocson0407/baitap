                                ...
                                <div class="cart-hover">
                                    <div id="change-item-cart"
                                        ...
                                        <div class="  d-flex justify-content-center ">
                                            <a href="{{url('/List-Cart')}}" class="btn btn-sm text-dark p-0" style="padding: 20px; background-color: #D19C97"><i
                                                    class="fa fa-shopping-cart mr-1"></i>Xem giỏ hàng</a>
                                            <a href="" class="btn btn-sm text-dark p-0"><i style="margin-left: 20px"
