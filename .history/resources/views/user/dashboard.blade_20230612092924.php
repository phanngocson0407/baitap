...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right">
                <ul class="  ">
                    <li   class="btn border"><a style="text-decoration: none"  href="#">
                            <i class="fas fa-heart text-primary"></i>
                    ...
                    <li class="btn border"   ><a style="text-decoration: none" href="#">
                        ...
                        <div class=" rounded-0 m-0"> <style>.cart_hover{
                            display: none;
                             position: absolute;          
                        }
                        .cart_hover:hover >#change-item-cart table{
    display:  block;
    z-index: 1000;} </style>
                            <div class="cart_hover" style="margin: 10px">
                                <div id="change-item-cart">                                  
