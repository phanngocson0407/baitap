                            ...
                            <div class="select-items">
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td   class="si-pic"><img style="width: 100px; height: 100px;" src="{{asset('frontend/img/carousel-1.jpg')}}" alt=""></td>
                                            <td class="si-text">
                                                <div class="product-selected">
                                                    <p>₫60.00 x 1</p>
                                                    <h6>Kabino Bedside Table</h6>
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link" data-toggle="dropdown">{{$item->tenthuonghieu}}<i class="fa fa-angle-down float-right mt-1"></i> </a>
                                <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                    @foreach ( $category   as $data)
                                    @if( $item->idthuonghieu == $data->id_thuonghieu )
                                        <a href="/shop/{{$data->idloaigiay}}"  class="dropdown-item" value=>{{ $data->name_category }}</a>
