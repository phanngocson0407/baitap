                                ...
                                <div class="cart-hover">
                                    <div id="change-item-cart"
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="si-text">
                                                            <div class="product-selected">
                                                                <p>{{(number_format($item['productInfo']->price))}} VNĐ x {{$item['quanty']}}
                                                                </p>
                                                        ...
                                                        <td class="si-text delete ">
                                                            ...
                                                            <button class="btn-xoa-cart btn btn-sm btn-primary " data="{{$item['productInfo']->id}}" value="{{$item['productInfo']->id_size.$item['productInfo']->id_color}}"> <i class="fa fa-times"></i></button>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                        ...
                                        <div class="select-total">
                                            <span>total:</span>
                                            <span><h5>{{(number_format(Session::get('Cart')->totalPrice))}}VNĐ</h5></span>
                                        </div>
