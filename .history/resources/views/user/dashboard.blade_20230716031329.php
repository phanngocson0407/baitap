                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="" >
                                                            ...
                                                            <h6 style="font-size: 12px">Size: {{$item['productInfo']->number_size}} </h6>
                                                            <h6 style="font-size: 12px">Màu: {{$item['productInfo']->name_color}} </h6>
                                                            <h6 style="font-size: 12px"  > 
                                                                Số lượng: {{$item['quanty']}}
                                                            </h6>
                                                            <h6 style="color:#D19C97;font-weight:500  ">{{(number_format($item['productInfo']->price))}}₫</h6>
                                                        </td>
