                                    ...
                                    <div id="change-item-cart"
                                        ...
                                        <div class="    ">
                                            <a href="{{url('/List-Cart')}}"
                                                class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i>
                                                </a>
                                                <a     href="{{url('/List-Cart')}}"> <button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Thanh Toán</button></a>
                                                <?php
                                                $data1=Session::get('data1');
                                                ?>
                                                @if( $data1 == null)
                                                     <a   href="{{URL::to('/login') }}"> <button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Thanh Toán</button></a>
                                                @else
                                                <a     href="{{URL('/checkout')}}"> <button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Thanh Toán</button></a>
                                                @endif
                                        </div>
