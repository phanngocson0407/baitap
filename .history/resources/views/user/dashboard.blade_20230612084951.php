...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="{{url('frontend')}}/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="{{url('frontend')}}/css/themify-icons.css" type="text/css">
    ...
    <link rel="stylesheet" href="{{url('frontend')}}/css/style1.css" type="text/css">
</head>
