                                ...
                                <div class="cart-hover">
                                    <div id="change-item-cart"
                                        ...
                                        <div class="select-items" style="margin-left: 20px;  ">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="si-text delete ">
                                                            ...
                                                            <button class="btn-xoa-cart btn btn-sm btn-primary "
                                            ...
                                            <div>
                                                @foreach(Session::get('Cart')->products as $item)
                                                <ul><li><a href=""><img style="height: 50px;"
                                                    src="/frontend/img/{{$item['productInfo']->image}}"
                                                    alt="" /></a></li>
                                                <li></li>
                                                <li></li></ul>
                                        ...
                                        <div class="select-button " style="display: flex">
                                            <a href="{{url('/List-Cart')}}" class="btn btn-primary px-3"><i
                                                    class="fa fa-shopping-cart mr-1"></i>Xem giỏ hàng</a>
                                            <a href="" class="btn btn-primary px-3"><i
