                                ...
                                <div class="cart-hover">
                                    <div id="change-item-cart"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="" >
                                                            ...
                                                            <h6 style="font-weight: 900;" >{{$item['productInfo']->name_product}} </h6>


                                                             

                                                            <h6 style="font-size: 13px">Size: {{$item['productInfo']->number_size}} </h6>
                                                            <h6 style="font-size: 13px">Màu: {{$item['productInfo']->name_color}} </h6>
                                                            <h6 style="font-size: 13px"  > 
                                                                Số lượng: {{$item['quanty']}}
                                                            </h6>
                                                            <h6 style="color:#D19C97;font-weight:700  ">{{(number_format($item['productInfo']->price))}}₫</h6>
                                                        </td>


                                                        <td class=" delete ">

                                                            <button style="padding: 20px" class="btn-xoa-cart btn btn-sm text-dark p-0 "
                                        ...
                                        <div class="select-total text-right" style="padding: 20px 10px; ">
                                            ...
                                            <span style="color:#D19C97;font-weight:700;font-size: 20px">{{(number_format(Session::get('Cart')->totalPrice))}}₫</span>
                                        </div>
