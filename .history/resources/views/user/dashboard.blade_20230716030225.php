                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="si-pic" style="margin: 20px">

                                                            <p style="margin: 20px; padding: -10px">{{$item['productInfo']->name_product}} </p>


                                                            <p style="margin: 20px; padding: -10px">{{(number_format($item['productInfo']->price))}}₫
                                                                x {{$item['quanty']}}
                                                            </p>

                                                            <p style="margin: 20px; padding: -10px">{{$item['productInfo']->number_size}} </p>
                                                            <p style="margin: 20px; padding: -10px">{{$item['productInfo']->name_color}} </p>
                                                        </td>
