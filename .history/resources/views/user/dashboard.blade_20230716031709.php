                            ...
                            <li>
                                <div class="cart-hover">
                                    <div id="change-item-cart"
                                        ...
                                        <div class="select-total text-right" style="padding: 20px 10px;font-size: 16px">
                                            <span>Tổng:</span>
                                            <span style="color:#D19C97;font-weight:700">{{(number_format(Session::get('Cart')->totalPrice))}}₫</span>
                                        </div>
