...
<div>
    <form action="/" method="get" style="width: 500px;">
        ...
        <div class="input-group">
            <input type="text" class="form-control" name="kw" placeholder="Tìm kiếm sản phẩm" value="{{ session('kw') }}">
            <input type="text" class="form-control" name="price" placeholder="Tìm kiếm theo giá" value="{{ session('price') }}">
