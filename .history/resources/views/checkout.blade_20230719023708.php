    ...
    <div class="container-fluid pt-5">
        ...
        <div class="col-lg-5">
            ...
            <form action="{{url('/momopayment')}}" method="post" style=" padding: 0px 19px;">
                ...
                <button style="border-radius: 10px; max-width: 300px; "  type="submit" name="redirect"  class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3" >Thanh Toán MoMo </button>           
            </form>
        </div>
        </div>
