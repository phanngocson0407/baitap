...
@section('user')
                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                                ...
                                <div class="input-group quantityy mx-auto" style="width: 100px;">
                                    <div class="input-group quantityy mr-3" style="width: 130px;">
                                        <div class="input-group-btn">
                                            <button class=" btn-primary btn-minus" >
                                            <i class="fa fa-minus"></i>
                                            </button>
                                        </div>
                                        <input type="text" class="form-control bg-secondary text-center" value="{{$item['quanty']}}">
                                        <div class="input-group-btn">
                                            <button class=" btn-primary btn-plus">
                            ...
                            <td class="align-middle"><button class="btn btn-sm btn-primary"><i onclick="DeleteListItemCart({{$item['productInfo']->id}});"  class=" "> cập nhật</i></button></td>
                        </tr>
                        @endforeach
                         @endif
                    </tbody>
    ...
    <script>
        ...
        var inputElement = document.querySelector('.quantityy input');
        var plusButton = document.querySelector('.quantityy .btn-plus');
        var minusButton = document.querySelector('.quantityy .btn-minus');
