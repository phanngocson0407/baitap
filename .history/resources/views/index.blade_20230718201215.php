        ...
        <div    >
            ...
            <div>
                ...
                <form action="/" method="get" >
                    ...
                    <select class="form-control select-filter text-center" name="sort" id="sort" style="width: 170px;">
                        ...
                        <input type="text" class="form-control" name="kw" placeholder="Tên sản phẩm"
                            value="<?php echo isset($_GET['kw']) ? $_GET['kw'] : ''; ?>">
                        <input type="text" class="form-control" name="price" placeholder="Tìm kiếm theo giá thấp nhất"
                            value="<?php echo isset($_GET['price']) ? $_GET['price'] : ''; ?>">
                            <input type="text" class="form-control" name="price2" placeholder="Tìm kiếm theo giá cao nhất"
