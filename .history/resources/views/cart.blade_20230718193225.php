            ...
            <table class="table table-bordered text-center mb-0">
                ...
                <tbody class="align-middle">
                    ...
                    <tr>
                        ...
                        <td class="align-middle">{{ number_format($item['price'], 0, '.', '.') . ' VNĐ' }}  VNĐ</td>
                        <td class="align-middle">
            ...
            <div class="card border-secondary mb-5">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <h6 class="font-weight-medium">{{(number_format(30000, 0, '.', '.') . ' VNĐ') }} </h6>
                    </div>
                </div>
                <div class="card-footer border-secondary bg-transparent">
                    <div class="d-flex justify-content-between mt-2">
                        <h5 class="font-weight-bold">Tổng giá</h5>
                    <h5 class="font-weight-bold">{{(number_format(Session::get('Cart')->totalPrice+30000, 0, '.', '.') . ' VNĐ'))}} VNĐ</h5>
                    </div>
                    <?php
