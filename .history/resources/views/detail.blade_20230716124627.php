        ...
        @if($item->status == 1)
            ...
            <div>
                ...
                <p class="font-weight-medium mb-0 mr-3">
                    <span class="text-dark" style="font-size: 15px; font-weight: 700; line-height: 22.4px;">Ngày:</span> <?php echo date('d/m/Y', strtotime($item->comment_date)); ?>
                </p>
                <p>
                    <span class="text-dark" style="font-size: 15px; font-weight: 700; line-height: 22.4px;">Bình luận:</span> {{$item->comment}}
                </p>
            </div>
        @endif
    @endforeach
