                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><button class="btn btn-sm btn-primary"><i onclick="SaceListItemCart({{$item['productInfo']->id}});"  id="save-cart-item-{{$item['productInfo']->id}}" class="">Cập nhật</i></button></td>
                        </tr>
                    @endforeach
                         @endif
                    </tbody>
