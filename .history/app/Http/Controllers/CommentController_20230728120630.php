...
class CommentController extends Controller
{
    ...
    public function insert_rating(Request $r) {
        ...
        ->join('order_detail','rating.id_product','=','order_detail.id_product')
        ->join('order_detail','order.id_product','=','order_detail.id_product')
        ...
        // ->where('order_detail.id_product',$data['id_product'])
        // ->where('order_detail.id_order',$data['id_product'])
