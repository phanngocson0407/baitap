    ...
    public function thankVNpay(){
        if(isset($_GET['vnp_Amount'])){
            $data_VNPAY =[
                ...
                'vnp_BankCode' =>$_GET['vnp_Amount'],
                'vnp_BankTranNo' =>$_GET['vnp_Amount'],
                'vnp_CardType' =>$_GET['vnp_Amount'],
                'vnp_PayDate' =>$_GET['vnp_Amount'],
                'vnp_ResponseCode' =>$_GET['vnp_Amount'],
                'vnp_TmnCode' =>$_GET['vnp_Amount'],
                'vnp_TxnRef' =>$_GET['vnp_Amount'],
                'vnp_TransactionNo' =>$_GET['vnp_Amount'],
                'vnp_TransactionStatus' =>$_GET['vnp_Amount'],
            ];
        }
    }
}