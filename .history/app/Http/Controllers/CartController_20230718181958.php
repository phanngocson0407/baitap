...
class CartController extends Controller
{
    ...
    public function checkout(Request $r)
    {
        ...
        $data1 =array();
        $data1['id_user']=$r->id_user;    
        $data1['consingnee_email']=$r->consingnee_email ; 
        $data1['consingnee_name']=$r->consingnee_name;
        $data1['consingnee_address']=$r->consingnee_address;
        $data1['consingnee_phone']=$r->consingnee_phone;
        $data1['vnp_TxnRef']=$r->vnp_TxnRef;
        $data1['vnp_TransactionNo']=$r->vnp_TransactionNo;
        $data1['vnp_PayDate']=$r->vnp_PayDate;
        $data1['vnp_BankCode']=$r->vnp_BankCode;
        $data1['vnp_OrderInfo']=$r->vnp_OrderInfo;
