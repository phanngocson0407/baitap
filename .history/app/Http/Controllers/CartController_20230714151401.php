...
class CartController extends Controller
{
    ...
    //                 return view('list-cart' );
    // }
    public function SaveListItemCart(Request $request, $id,
    jquery-3.4.1.min.js:2     GET http://127.0.0.1:8000/Save-List-Item-Cart/70?id_color_size=10364&quantity=6 500 (Internal Server Error)
    send @ jquery-3.4.1.min.js:2
    ajax @ jquery-3.4.1.min.js:2
    (anonymous) @ List-Cart:593
    dispatch @ jquery-3.4.1.min.js:2
    v.handle @ jquery-3.4.1.min.js:2 $quanty)
{
    $id_color_size = $request->id_color_size ?? '';
