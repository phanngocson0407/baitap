...
class CommentController extends Controller
{
    ...
    public function insert_rating(Request $r) {
        ...
        // $check_rating = Rating::where('rating','rating.id_user',$data['id_user'])
        // ->where('rating','rating.id_product ',$data['id_product '])->first();
    ...
    public function check_rating(Request $request){
        ...
        if($check_rating !=null){
            ...
            $rating->rating=$dacheckta['index'];
            $rating->id_user=$checkata['id_user'];
            $rating->save();
            echo 'done';
        }
    }
